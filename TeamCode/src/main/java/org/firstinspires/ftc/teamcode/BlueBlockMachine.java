...
import org.firstinspires.ftc.teamcode.teamcode.JustSkyStoneNavigationState;
...
public class BlueBlockMachine extends OpMode{
    ...
    org.firstinspires.ftc.teamcode.teamcode.driveState moveALittle;
    ...
    org.firstinspires.ftc.teamcode.teamcode.driveState goToMiddleBlock;
    ...
    public void init(){
       ...
       // int cameraMonitorViewId = this.hardwareMap.appContext.getResources().getIdentifier("cameraMonitorViewId", "id", hardwareMap.appContext.getPackageName());
        ...
        goToMiddleBlock = new org.firstinspires.ftc.teamcode.teamcode.driveState(.3,.5,motors,"forward");
        ...
        moveALittle = new org.firstinspires.ftc.teamcode.teamcode.driveState(6, .5, motors, "left");//added this to move a little
