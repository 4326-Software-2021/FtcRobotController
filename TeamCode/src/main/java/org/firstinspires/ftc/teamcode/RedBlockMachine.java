...
import org.firstinspires.ftc.teamcode.JustSkyStoneNavigationState;
import org.firstinspires.ftc.teamcode.OpenClosePulleyState;
...
import org.firstinspires.ftc.teamcode.teamcode.movePulleyState;
...
public class RedBlockMachine extends OpMode{
    ...
    Servo clasp;
    BNO055IMU imu;
    org.firstinspires.ftc.teamcode.teamcode.driveState approachBlocks;
    GyroTurnCCWByPID turnBlock;
    org.firstinspires.ftc.teamcode.teamcode.driveState getOffBlock;
    org.firstinspires.ftc.teamcode.teamcode.driveState moveBackFromBlock;
    GyroTurnCCWByPID turnFromBlock;
    OpenClosePulleyState close;
    OpenClosePulleyState open;

    org.firstinspires.ftc.teamcode.teamcode.movePulleyState moveDown;
    movePulleyState moveUp;

    org.firstinspires.ftc.teamcode.teamcode.distanceState moveALittle;
  //  GyroTurnCWByPID reposition;
   ...
   // driveState goToMiddleBlock;
    ...
    org.firstinspires.ftc.teamcode.teamcode.driveState leaveCorner;



DistanceSensor distance;
    //GyroTurnCCWByPID turn1;
    org.firstinspires.ftc.teamcode.teamcode.distanceState approach;
    ...
    public void init(){
        ...
        approach = new org.firstinspires.ftc.teamcode.teamcode.distanceState(distance, 0.5, 1 /*need to measure how far away from the blocks to stop*/, motors, "forward", "fc");

        approachBlocks = new org.firstinspires.ftc.teamcode.teamcode.driveState(24.1,.5,motors,"forward");
    ...
    //    reposition = new GyroTurnCWByPID(6.5, 0.5, motors, imu); //clockwise
        ...
        getOffBlock = new org.firstinspires.ftc.teamcode.teamcode.driveState(22, .5 , motors, "right");
